 ...
 * {@link CityDetailActivity} representing song details. When one is
...
public class MainActivity extends AppCompatActivity {
    ...
    class SimpleItemRecyclerViewAdapter
        ...
        private final List<CityUtils.CityInfo> mValues;

        SimpleItemRecyclerViewAdapter(List<CityUtils.CityInfo> items) {
            mValues = items;
        }
